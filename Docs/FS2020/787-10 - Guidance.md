...
### PREFLIGHT (CTRL-7 / CTRL-8)
   ...
   - [ ] **ELECTRICAL** - Generator control switches to ON position (GEN CTRL L1/L2/R1/R2) (CTRL-7, Column 1, Center)
   ...
   - [ ] **EMER LIGHTS** - Close Guard (ARMED by default)(CTRL-8, Column 2, Top)
   - [ ] **WINDOW HEAT** - Turn Primary heat switches to ON (Primary SIDE-L/FWD-L/FWD-R/SIDE-R) (CTRL-7, Column 2, Center)
   - [ ] **HYDRAULIC** - Primary ENG switches to ON (L ENG/R ENG) (CTRL-7, Column 2, Center)
...
### PREFLIGHT (CTRL-2)
   ...
   - [ ] **NAVIGATION** - Auto Throttle (A/T ARM) switch to ARM
   ...
   - [ ] SPEEDBRAKE - Ensure Speedbrake lever is DOWN (top knotch) (CTRL-4, Middle-Left)
...
### BEFORE STARTING ENGINE (CTRL-7)
   ...
   - [ ] **FUEL** - Toggle PUMPS to ON position (L PUMPS-FWD&AFT/C PUMPS-L&R/R PUMPS-FWD&AFT) (CTRL-7, Column 3, Center)
...
### STARTING ENGINE (CTRL-8)
   ...
   - [ ] **EICAS** - Monitor for Engine Start/Running in [Engine-indicating and crew-alerting system](https://en.wikipedia.org/wiki/Engine-indicating_and_crew-alerting_system) (EICAS) display
...
### TAKE OFF
   - [ ] **PARKING BRAKE** - Ensure Parking Brake is in OFF position (CTRL-4, Left)
   - [ ] **POWER LEVER** - Press TO/GA button in front of power levers (CTRL-1, swivel had to right and press surface in front of levers)
...
### APPROACH
   - [ ] **LIGHTS** Turn LANDING lights L/NOSE/R to ON (down position) (CTRL-7, Column 2, Bottom)
   - [ ] **LIGHTS** Turn TAXI lights ON (down position) (CTRL-7, Column 3, Bottom)

 ### LANDING
   - [ ] **LANDING GEAR** - Landing Gear Lever to DOWN position (default) (CTRL-2, Center, Down)
   - [ ] **FLAPS** - Set to 20 degrees (or as required) (C+TRL-4)
